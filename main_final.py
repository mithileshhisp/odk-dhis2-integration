...
def get_existing_child_tei(session_dhis2, dhis2_api_url, child_unique_id, orgunit_uid, program_uid="pUOYd7YC9GN"):
    ...
    #response = session_post.get(f"{dhis2_get_url}/tracker/trackedEntities?ou={orgunit_uid}&ouMode=SELECTED&program=pUOYd7YC9GN", params={"filter": f"aAMjO9TQK0I:EQ:{event_id}"})    
