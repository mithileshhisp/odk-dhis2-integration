...
#from constants import ODK_AUTH, ODK_API_URL, DHIS2_API_URL, DHIS2_AUTH, LOG_FILE_RAJASTHAN
from constants import LOG_FILE_RAJASTHAN
from utils import (
    configure_logging,
    log_info,
    log_error,
...
ODK_API_URL_RAJASTHAN = os.getenv("ODK_API_URL_RAJASTHAN")
...
def fetch_odk_data():
    try:
        ...
        updated_odk_ssbsk_api_url = f"{ODK_API_URL_RAJASTHAN}?$filter=__system/submissionDate ge {ODK_FILTER_DATE}"
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=1) as executor:
        try:
            configure_logging( LOG_FILE_RAJASTHAN )
